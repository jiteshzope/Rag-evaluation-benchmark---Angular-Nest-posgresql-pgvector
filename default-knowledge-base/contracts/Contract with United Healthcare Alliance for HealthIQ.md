# Contract with United Healthcare Alliance for HealthIQ
...
1. **Coverage:** Assurio agrees to provide United Healthcare Alliance with enterprise access to the HealthIQ platform, including extensive customization, multi-state support, dedicated infrastructure, and premium support services for their nationwide health insurance operations covering 250,000+ members across 12 states.

2. **Duration:** This agreement is effective for a period of 48 months from the contract date, representing Assurio's most strategic long-term healthcare partnership.
...
4. **Service Level Agreement:** Assurio guarantees 99.95% uptime measured monthly, with financial credits: 7% monthly credit for each hour of unplanned downtime exceeding the SLA, maximum 50% monthly credit.
...
6. **Security and Compliance:** Assurio commits to maintaining HIPAA compliance, HITRUST certification, SOC 2 Type II, and annual third-party security audits with penetration testing.
...
United Healthcare Alliance will receive the complete HealthIQ Enterprise suite with custom enhancements:
...
Assurio commits to comprehensive Enterprise-level support for United Healthcare Alliance:
...
3. **Comprehensive Implementation:**
   ...
   - Go-live support with 12-week on-site Assurio team presence (6-10 people)
...
7. **Analytics and Reporting:**
   ...
   - Access to Assurio's proprietary healthcare benchmarking database
...
9. **Continuous Improvement:**
   ...
   - Best practice sharing from across Assurio's customer base
...
This agreement establishes United Healthcare Alliance as Assurio's flagship enterprise health insurance partner, representing the most comprehensive strategic partnership in Assurio's history. This partnership will drive innovation in healthcare technology and set new standards for AI-powered health insurance operations. This contract supersedes all prior agreements and communications.
