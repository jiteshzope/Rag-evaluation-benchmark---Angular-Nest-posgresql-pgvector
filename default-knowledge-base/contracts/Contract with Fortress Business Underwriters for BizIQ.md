# Contract with Fortress Business Underwriters for BizIQ
...
3. **Subscription Type**: Fortress Business Underwriters agrees to subscribe to the **Professional Tier** of BizIQ, at a cost of $12,000/month, totaling $288,000 for the duration of this contract.
...
3. **API Access**: Limited API access for integrating BizIQ with existing underwriting workbenches and agency management systems (up to 100,000 API calls/month).
...
1. **Technical Support**: Fortress Business Underwriters will receive priority technical support from Assurio, including:
...
2. **Training**: Assurio will provide:
...
*This contract outlines the terms of the relationship between Assurio and Fortress Business Underwriters for the BizIQ product, establishing a partnership to transform commercial insurance underwriting operations.*
