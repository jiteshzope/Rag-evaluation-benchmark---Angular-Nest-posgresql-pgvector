# Contract with Advantage Medical Coverage for HealthIQ
...
1. **Parties Involved**: This contract is entered into between Assurio, Inc. ("Provider") and Advantage Medical Coverage ("Client").

2. **License Grant**: Assurio grants Advantage Medical Coverage a non-exclusive, non-transferable license to use the HealthIQ Professional Tier platform.
...
1. **Included Features**: Advantage Medical Coverage will have access to HealthIQ Professional Tier features:
...
1. **Customer Support**: Assurio will provide priority support to Advantage Medical Coverage:
