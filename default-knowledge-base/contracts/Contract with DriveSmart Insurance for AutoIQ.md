# Contract with DriveSmart Insurance for AutoIQ
...
1. **Coverage:** Assurio agrees to provide DriveSmart Insurance with enterprise access to the AutoIQ platform, including white-label capabilities, unlimited user licenses, dedicated infrastructure, and full API access for their multi-state auto insurance operations.
...
5. **Service Level Agreement:** Assurio guarantees 99.9% platform uptime measured monthly, with 8% monthly credit for each 0.1% below target, maximum 40% monthly credit.
...
7. **Data Security:** Assurio maintains SOC 2 Type II compliance, annual penetration testing, and comprehensive cyber insurance coverage.
...
DriveSmart Insurance will receive the complete AutoIQ Enterprise suite:
...
Assurio commits to comprehensive Enterprise-level support for DriveSmart Insurance:
...
This agreement establishes DriveSmart Insurance as a premier enterprise partner leveraging AutoIQ's advanced AI and telematics capabilities to transform auto insurance operations. This contract supersedes all prior agreements.
