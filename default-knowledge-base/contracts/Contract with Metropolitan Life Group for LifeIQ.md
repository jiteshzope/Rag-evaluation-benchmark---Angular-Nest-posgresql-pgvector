# Contract with Metropolitan Life Group for LifeIQ
...
1. **Coverage:** Assurio agrees to provide Metropolitan Life Group with enterprise access to the LifeIQ platform, including white-label capabilities, full customization, dedicated support, and enterprise-grade security for their nationwide life insurance operations managing 50,000+ active policies.
...
4. **Service Level Agreement:** Assurio guarantees 99.9% uptime measured monthly, with 10% monthly credit for each 0.1% below target, maximum 30% credit.
...
6. **Data Security:** Assurio commits to maintaining HIPAA compliance, SOC 2 Type II certification, and annual third-party security audits.
...
Metropolitan Life Group will receive the complete LifeIQ Enterprise suite:
...
Assurio commits to comprehensive Enterprise-level support for Metropolitan Life Group:
...
3. **Comprehensive Implementation:**
   ...
   - Go-live support with 8-week on-site Assurio team presence
...
This agreement establishes Metropolitan Life Group as Assurio's flagship enterprise life insurance partner, representing a strategic partnership to transform life insurance through cutting-edge AI technology and innovation. This contract supersedes all prior agreements and communications.
