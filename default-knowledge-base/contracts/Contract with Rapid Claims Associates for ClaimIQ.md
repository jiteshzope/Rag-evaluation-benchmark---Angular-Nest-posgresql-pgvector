# Contract with Rapid Claims Associates for ClaimIQ
...
1. **Coverage:** Assurio agrees to provide Rapid Claims Associates with access to the ClaimIQ platform, enabling AI-powered claims processing, automated triage, and streamlined claims management across property, casualty, and auto lines.
...
6. **Data Ownership:** Rapid Claims Associates retains ownership of all claims data. Assurio may use anonymized, aggregated data for product improvement.

7. **Liability:** Assurio's liability is limited to direct damages not exceeding total fees paid in the preceding 6 months.
...
Assurio commits to providing comprehensive support to Rapid Claims Associates:
...
5. **Integration Support:** Technical assistance connecting ClaimIQ with:
...
This agreement represents the complete understanding between Assurio and Rapid Claims Associates regarding the ClaimIQ platform and supersedes any prior communications or agreements.
