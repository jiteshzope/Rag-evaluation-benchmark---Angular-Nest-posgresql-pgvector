# Contract with ConnectInsure Agency for MarketIQ
...
1. **Parties Involved**: This contract is entered into between Assurio, Inc. ("Provider") and ConnectInsure Agency ("Client").
...
4. **Fee Structure**: ConnectInsure Agency agrees to a hybrid pricing model:
   - Basic Listing Fee: $199/month for featured placement on the MarketIQ platform
   - Performance-Based Pricing: $25 per qualified lead generated through MarketIQ
   - Premium Analytics Package (optional): $99/month for enhanced data insights and reporting

5. **Lead Volume Expectations**: Based on ConnectInsure's profile, MarketIQ projects 80-120 qualified leads per month, resulting in estimated monthly costs of $2,199-$3,199.
...
8. **Dispute Resolution**: Lead quality disputes must be submitted within 5 business days with documentation. Assurio will credit for validated low-quality leads.
...
1. **AI-Powered Matching**: ConnectInsure Agency will benefit from MarketIQ's sophisticated matching:
...
This contract enables ConnectInsure Agency to leverage MarketIQ's AI-powered marketplace to connect with qualified insurance shoppers and grow their business through data-driven lead generation.
