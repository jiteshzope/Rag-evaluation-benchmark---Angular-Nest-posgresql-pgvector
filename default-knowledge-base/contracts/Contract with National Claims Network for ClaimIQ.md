# Contract with National Claims Network for ClaimIQ
...
1. **Coverage:** Assurio agrees to provide National Claims Network with enterprise access to the ClaimIQ platform, including white-label capabilities, unlimited claims capacity, advanced fraud analytics, and dedicated infrastructure to support their nationwide claims operations processing over 100,000 claims annually.

2. **Duration:** This agreement is effective for a period of 36 months from the contract date, representing Assurio's longest-term contract commitment to date.
...
4. **Service Level Agreement:** Assurio guarantees 99.95% uptime with financial credits for downtime: 5% monthly credit for each hour of unplanned downtime, maximum 50% monthly credit.
...
6. **Data Security:** Assurio commits to maintaining SOC 2 Type II compliance, annual penetration testing, and end-to-end encryption for all data at rest and in transit.

7. **Business Continuity:** Assurio provides disaster recovery with 4-hour RTO (Recovery Time Objective) and 1-hour RPO (Recovery Point Objective).
...
National Claims Network will receive the complete ClaimIQ Enterprise suite:
...
Assurio commits to comprehensive Enterprise-level support for National Claims Network:
...
3. **Comprehensive Implementation:**
   ...
   - Go-live support with on-site Assurio team (4 weeks)
...
8. **Continuous Improvement:**
   ...
   - Best practice sharing from across Assurio customer base
...
This agreement represents a strategic partnership between Assurio and National Claims Network, establishing National Claims Network as Assurio's flagship enterprise claims processing partner. This contract supersedes all prior agreements and communications.
