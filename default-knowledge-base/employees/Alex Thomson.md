...
- **November 2022** - Joined Assurio as a Sales Development Representative. Alex Thomson quickly adapted to the team, demonstrating exceptional communication and rapport-building skills.
...
- **August 2023** - Developed a training module for new SDRs at Assurio, enhancing onboarding processes based on feedback and strategies that Alex Thomson pioneered.  
...
## Other HR Notes
- Alex Thomson is an active member of the Diversity and Inclusion committee at Assurio and has participated in various community outreach programs.  
...
--- 
**Comment:** Alex Thomson is considered a cornerstone of Assurio’s sales team and has a bright future within the organization.